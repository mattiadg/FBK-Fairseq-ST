...
class TranslationTask(FairseqTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        if not args.audio_input:
            ...
            src_dict = AudioDictionary.load(os.path.join(args.data[0], 'dict.{}.txt'.format(args.source_lang)))
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        for dk, data_path in enumerate(data_paths):
            for k in itertools.count():
                ...
                if self.args.audio_input:
                    ...
                    src_datasets.append(indexed_dataset(prefix + src, self.src_dict, cached=cached, audio=True))
                    tgt_datasets.append(indexed_dataset(prefix + tgt, self.tgt_dict, cached=cached))
                else:
        ...
        if self.args.audio_input:
            ...
            self.src_dict.audio_features = self.audio_features
